    ...
    <div
      ...
      <template v-if="autoGeneratedPassword">
        <a href="javascript:void(0);" @click="dialog = true">
          {{ $t('exoplatform.wallet.button.setWalletPassword') }}
        </a>
      </template>
      <template v-else>
        <button
      ...
      <div class="popupHeader ClearFix">
        <a
          ...
          @click="close"></a> <span class="PopupTitle popupTitle">
            {{ rememberPasswordToChange ? $t('exoplatform.wallet.warning.requiredPassword') : autoGeneratedPassword ? $t('exoplatform.wallet.button.setWalletPassword') : $t('exoplatform.wallet.button.resetWalletPassword') }}
          </span>
      </div>
