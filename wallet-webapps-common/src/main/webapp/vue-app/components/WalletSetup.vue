...
export default {
  ...
  computed: {
    ...
    displayWalletCreationToolbar() {
      return this.wallet.provider === 'MEEDS_WALLET' && !this.loading && this.walletAddress && !this.browserWalletExists && this.isReadOnly && (!this.isSpace || this.isSpaceAdministrator);
    },
    displayWalletBackup() {
