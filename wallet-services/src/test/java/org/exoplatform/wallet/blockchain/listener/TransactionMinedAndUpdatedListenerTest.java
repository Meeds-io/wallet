...
public class TransactionMinedAndUpdatedListenerTest {
  ...
  @Before
  public void setUp() {
    event = new Event<Object, TransactionDetail>(WalletUtils.TRANSACTION_MODIFIED_EVENT, null, transactionDetail);
    listener = new TransactionMinedAndUpdatedListener(walletTransactionService, blockchainTransactionService);
  }
  ...
  public void testOnEventWhenNoPendingTransactions() throws Exception {
    ...
    verify(blockchainTransactionService, times(1)).stopWatchingBlockchain();
  }
  ...
  public void testOnEventWhenHavingPendingTransactions() throws Exception {
    ...
    verify(blockchainTransactionService, times(0)).stopWatchingBlockchain();
  }
