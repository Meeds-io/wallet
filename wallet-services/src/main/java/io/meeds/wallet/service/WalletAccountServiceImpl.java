...
import static io.meeds.wallet.wallet.utils.WalletUtils.ADMIN_KEY_PARAMETER;
import static io.meeds.wallet.wallet.utils.WalletUtils.MODIFY_ADDRESS_ASSOCIATED_EVENT;
import static io.meeds.wallet.wallet.utils.WalletUtils.NEW_ADDRESS_ASSOCIATED_EVENT;
import static io.meeds.wallet.wallet.utils.WalletUtils.SIMPLE_CHARS;
import static io.meeds.wallet.wallet.utils.WalletUtils.WALLET_ADMIN_REMOTE_ID;
import static io.meeds.wallet.wallet.utils.WalletUtils.WALLET_DELETED_EVENT;
import static io.meeds.wallet.wallet.utils.WalletUtils.WALLET_DISABLED_EVENT;
import static io.meeds.wallet.wallet.utils.WalletUtils.WALLET_ENABLED_EVENT;
import static io.meeds.wallet.wallet.utils.WalletUtils.WALLET_INITIALIZATION_MODIFICATION_EVENT;
...
import static io.meeds.wallet.wallet.utils.WalletUtils.checkUserIsSpaceManager;
import static io.meeds.wallet.wallet.utils.WalletUtils.computeWalletFromIdentity;
import static io.meeds.wallet.wallet.utils.WalletUtils.computeWalletIdentity;
...
import static io.meeds.wallet.wallet.utils.WalletUtils.getSpacePrettyName;
...
import static io.meeds.wallet.wallet.utils.WalletUtils.isUserSpaceManager;
...
public class WalletAccountServiceImpl implements WalletAccountService, ExoWalletStatisticService, Startable {
  ...
  @Override
  public Set<Wallet> listWalletsByIdentityIds(List<Long> identityIds) {
    Set<Wallet> wallets = accountStorage.findListByIdentityIds(identityIds);
    wallets.forEach(wallet -> {
      retrieveWalletBlockchainState(wallet);
      hideWalletOwnerPrivateInformation(wallet);
    });
