...
@NamedQueries({
    ...
    @NamedQuery(name = "WalletTransaction.countTransactionsByNonce", query = "SELECT tx FROM WalletTransaction tx WHERE tx.nonce = :nonce AND tx.networkId = :networkId AND tx.fromAddress = :address"),
