...
@NamedQueries({
    ...
    @NamedQuery(name = "WalletTransaction.getAddressLastPendingTransactionSent", query = "SELECT tx FROM WalletTransaction tx WHERE tx.fromAddress = :address AND tx.isPending = TRUE ORDER BY tx.createdDate DESC"),
