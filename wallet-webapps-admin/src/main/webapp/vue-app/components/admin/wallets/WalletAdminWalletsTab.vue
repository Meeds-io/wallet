                ...
                <v-list flat class="pt-0 pb-0">
                  <template>
                    <template v-if="useWalletAdmin">
                      ...
                      <v-list-tile v-if="!contractDetails.isPaused && !props.item.disabledUser && !props.item.deletedUser && props.item.enabled && props.item.isApproved && tokenAmount > 0 && props.item.tokenBalance < tokenAmount" @click="openSendTokenModal(props.item)">
