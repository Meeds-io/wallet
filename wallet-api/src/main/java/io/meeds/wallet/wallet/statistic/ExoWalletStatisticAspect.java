 ...
 */
package io.meeds.wallet.wallet.statistic;
...
import static io.meeds.wallet.wallet.statistic.StatisticUtils.addStatisticEntry;
...
public class ExoWalletStatisticAspect {
   ...
   */
  @Around("execution(* *(..)) && @annotation(io.meeds.wallet.wallet.statistic.ExoWalletStatistic)")
